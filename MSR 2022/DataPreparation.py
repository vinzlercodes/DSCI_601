...
class DataPreparation:
    ...
    def split(self, df):
        ...
        X_train.to_csv(r'../MSR 2022/Train_Features.csv')
        y_train.to_csv(r'../MSR 2022/Train_Labels.csv')
        X_test.to_csv(r'../MSR 2022/Test_Features.csv')
        y_test.to_csv(r'../MSR 2022/Test_Labels.csv')
    ...
    def __call__(self):
        ...
        self.dataFrame.to_csv("../MSR 2022/Preprocessed22.csv")
...
if __name__ == "__main__":
    start = time.time()
    # Load data
    data = pd.read_csv(r'../MSR 2022/sample_SATD30ktop.csv')
